...
import { publish as publishPackages, readChangesetState, version as versionPackages, } from "@changesets/release-utils";
const run = async () => {
    ...
    if (!preState || preState.mode === "exit") {
        ...
        core.info(`Published packages: ${JSON.stringify(publishResult.published, null, 2)}`);
