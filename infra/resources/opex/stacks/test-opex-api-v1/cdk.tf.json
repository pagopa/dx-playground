  ...
  "resource": {
    "azurerm_monitor_scheduled_query_rules_alert": {
      "avail-alert-delete-tasks--taskId": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/avail-alert-delete-tasks--taskId",
        ...
        "name": "Alert-Avail-test-opex-api-v1-delete-tasks--taskId",
      ...
      "avail-alert-get-info": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/avail-alert-get-info",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-Avail-test-opex-api-v1-get-info",
      ...
      "avail-alert-get-tasks": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/avail-alert-get-tasks",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-Avail-test-opex-api-v1-get-tasks",
        "query": "\n  let threshold = 0.99;\n  AzureDiagnostics\n  | where ResourceProvider == \"MICROSOFT.APIMANAGEMENT\"\n    and url_s matches regex \"/tasks$\"\n  | summarize\n    Total=count(),\n    Success=count(responseCode_d < 500) by bin(TimeGenerated, 5m)\n  | extend availability=toreal(Success) / Total\n  | where availability < threshold\n",
        "resource_group_name": "${azurerm_resource_group.rg.name}",
        "severity": 2,
        "tags": {
      ...
      "avail-alert-get-tasks--taskId": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/avail-alert-get-tasks--taskId",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-Avail-test-opex-api-v1-get-tasks--taskId",
        "query": "\n  let threshold = 0.99;\n  AzureDiagnostics\n  | where ResourceProvider == \"MICROSOFT.APIMANAGEMENT\"\n    and url_s matches regex \"/tasks/[^/]+$\"\n  | summarize\n    Total=count(),\n    Success=count(responseCode_d < 500) by bin(TimeGenerated, 5m)\n  | extend availability=toreal(Success) / Total\n  | where availability < threshold\n",
        "resource_group_name": "${azurerm_resource_group.rg.name}",
        "severity": 2,
        "tags": {
      ...
      "avail-alert-post-tasks": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/avail-alert-post-tasks",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-Avail-test-opex-api-v1-post-tasks",
        "query": "\n  let threshold = 0.99;\n  AzureDiagnostics\n  | where ResourceProvider == \"MICROSOFT.APIMANAGEMENT\"\n    and url_s matches regex \"/tasks$\"\n  | summarize\n    Total=count(),\n    Success=count(responseCode_d < 500) by bin(TimeGenerated, 5m)\n  | extend availability=toreal(Success) / Total\n  | where availability < threshold\n",
        "resource_group_name": "${azurerm_resource_group.rg.name}",
        "severity": 2,
        "tags": {
      ...
      "resptime-alert-delete-tasks--taskId": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/resptime-alert-delete-tasks--taskId",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-RespTime-test-opex-api-v1-delete-tasks--taskId",
      ...
      "resptime-alert-get-info": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/resptime-alert-get-info",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-RespTime-test-opex-api-v1-get-info",
      ...
      "resptime-alert-get-tasks": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/resptime-alert-get-tasks",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-RespTime-test-opex-api-v1-get-tasks",
        "query": "\n  let threshold = 1000;\n  AzureDiagnostics\n  | where url_s matches regex \"/tasks$\"\n  | summarize\n      watermark=threshold,\n      duration_percentile_95=percentiles(todouble(DurationMs)/1000, 95) by bin(TimeGenerated, 5m)\n  | where duration_percentile_95 > threshold\n  ",
        "resource_group_name": "${azurerm_resource_group.rg.name}",
        "severity": 2,
        "tags": {
      ...
      "resptime-alert-get-tasks--taskId": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/resptime-alert-get-tasks--taskId",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-RespTime-test-opex-api-v1-get-tasks--taskId",
        "query": "\n  let threshold = 1000;\n  AzureDiagnostics\n  | where url_s matches regex \"/tasks/[^/]+$\"\n  | summarize\n      watermark=threshold,\n      duration_percentile_95=percentiles(todouble(DurationMs)/1000, 95) by bin(TimeGenerated, 5m)\n  | where duration_percentile_95 > threshold\n  ",
        "resource_group_name": "${azurerm_resource_group.rg.name}",
        "severity": 2,
        "tags": {
      ...
      "resptime-alert-post-tasks": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/resptime-alert-post-tasks",
        ...
        "frequency": 5,
        "location": "Italy North",
        "name": "Alert-RespTime-test-opex-api-v1-post-tasks",
        "query": "\n  let threshold = 1000;\n  AzureDiagnostics\n  | where url_s matches regex \"/tasks$\"\n  | summarize\n      watermark=threshold,\n      duration_percentile_95=percentiles(todouble(DurationMs)/1000, 95) by bin(TimeGenerated, 5m)\n  | where duration_percentile_95 > threshold\n  ",
        "resource_group_name": "${azurerm_resource_group.rg.name}",
        "severity": 2,
        "tags": {
    ...
    "azurerm_portal_dashboard": {
      "api-dashboard": {
        "//": {
          "metadata": {
            "path": "test-opex-api-v1/api-dashboard",
        ...
        "location": "Italy North",
        "name": "Dashboard-test-opex-api-v1",
        "resource_group_name": "${azurerm_resource_group.rg.name}",
        "tags": {
          "BusinessUnit": "DevEx",
          "CostCenter": "TS000 - Tecnologia e Servizi",
          ...
          "Scope": "Opex PoC",
          "Source": "https://github.com/pagopa/dx-playground/tree/main/infra/repository",
          "hidden-title": "Dashboard-test-opex-api-v1"
        }
      }
    },
