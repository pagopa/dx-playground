...
readonly FUNCTION_CONFIG_FILE=./scripts/dynatrace-azure-forwarder.json
...
readonly FUNCTION_REPOSITORY_RELEASE_URL=https://github.com/dynatrace-oss/dynatrace-azure-log-forwarder/releases/download/release-0.2.4/
...
if [ "$ENABLE_USER_ASSIGNED_MANAGED_IDENTITY" = "true" ]; then
  ...
  --resource-group ${RESOURCE_GROUP} \
  --template-file ${FUNCTION_CONFIG_FILE} \
...
FUNCTIONAPP_NAME="dx-d-itn-${DEPLOYMENT_NAME}-fn-01"
echo
